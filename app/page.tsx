          ...
          <div className="bg-gray-800 rounded-lg p-4 border border-gray-700 w-64">
            ...
            <nav className="space-y-3">
              ...
              {availableArchives.map((archive) => {
                // Convert internal archive ID to user-friendly display name
                const getDisplayName = (archiveId: string) => {
                  // Convert "7d_ago" to "1 week ago", others like "1d_ago" to "1d ago"
                  if (archiveId === '7d_ago') {
                    return '1 week ago';
                  }
                  return archiveId.replace('_', ' ');
                };
                ...
                return (
                  ...
                  >
                    ...
                    <span>{getDisplayName(archive.id)}</span>
                  </button>
                );
              })}
